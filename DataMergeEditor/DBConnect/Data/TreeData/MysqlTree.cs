...
{
    public class MysqlTree : IMysqlTree
    {
        ...
        public TreeNodeViewModel BuildTree(MySqlConnection connection)
        {
            ...
            {
                Name = connection.Database + " - MySql",
            ...
            //-- Tilføjer rootNode til DataBaseConnectionTreeViewModel Items liste 
            return rootNode;
        }
